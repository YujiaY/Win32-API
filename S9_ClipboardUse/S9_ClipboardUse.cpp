...
static LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_CREATE:
		CreateWindow(TEXT("STATIC"), TEXT("Fucking IT!"), WS_CHILD | WS_VISIBLE, 10, 160, 100, 20, hWnd, (HMENU)IDC_LABEL, NULL, NULL);
		...
		hBmp = (HBITMAP)LoadImage(NULL, TEXT("8.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
